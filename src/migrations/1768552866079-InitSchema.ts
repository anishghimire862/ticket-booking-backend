...
export class InitSchema1768552866079 implements MigrationInterface {
  name = 'InitSchema1768552866079'
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "ticket_tiers" ("id" SERIAL NOT NULL, "eventId" integer NOT NULL, "code" text NOT NULL, "displayName" text NOT NULL, "priceCents" integer NOT NULL, "displayOrder" integer NOT NULL DEFAULT '0', "isActive" boolean NOT NULL DEFAULT true, "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), CONSTRAINT "UQ_b9b2713bf961a23d46373de875b" UNIQUE ("eventId", "code"), CONSTRAINT "PK_917cfec124fa5e8ce04d1e7b865" PRIMARY KEY ("id"))`,
    )
    await queryRunner.query(
      `CREATE INDEX "IDX_a9059a9111a2206081a347d3b6" ON "ticket_tiers" ("eventId") `,
    )
    await queryRunner.query(
      `CREATE INDEX "IDX_ca0d01b987360510a18c6ee471" ON "ticket_tiers" ("isActive") `,
    )
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE INDEX "IDX_0fd5eb3553b7b0344337b86123" ON "ticket_inventory" ("tierId") `,
    )
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE INDEX "IDX_13671e33965ca9dca96bd3c733" ON "booking_items" ("bookingId") `,
    )
    await queryRunner.query(
      `CREATE INDEX "IDX_085e1a8e356452278626ce04f5" ON "booking_items" ("tierId") `,
    )
    await queryRunner.query(
      `CREATE TABLE "bookings" ("id" SERIAL NOT NULL, "eventId" integer NOT NULL, "userId" integer NOT NULL, "status" text NOT NULL, "totalAmountCents" integer NOT NULL, "idempotencyKey" text NOT NULL, "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), CONSTRAINT "UQ_d1844ed4216c0cbdbeb40c85004" UNIQUE ("idempotencyKey"), CONSTRAINT "PK_bee6805982cc1e248e94ce94957" PRIMARY KEY ("id"))`,
    )
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`DROP INDEX "public"."IDX_085e1a8e356452278626ce04f5"`)
    await queryRunner.query(`DROP INDEX "public"."IDX_13671e33965ca9dca96bd3c733"`)
    await queryRunner.query(`DROP TABLE "booking_items"`)
    await queryRunner.query(`DROP INDEX "public"."IDX_0fd5eb3553b7b0344337b86123"`)
    await queryRunner.query(`DROP TABLE "ticket_inventory"`)
    await queryRunner.query(`DROP INDEX "public"."IDX_ca0d01b987360510a18c6ee471"`)
    await queryRunner.query(`DROP INDEX "public"."IDX_a9059a9111a2206081a347d3b6"`)
